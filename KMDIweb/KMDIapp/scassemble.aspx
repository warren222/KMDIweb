<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KMDIapp/KMDIwebMaster.Master" CodeBehind="scassemble.aspx.cs" Inherits="KMDIweb.KMDIapp.scassemble" %>
        ...
        <ContentTemplate>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4><span><strong>Assemble Checklist</strong> </span></h4>
                    <div class="row">
                        <div class="col-sm-6">
                    ...
                    <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto">
                       <asp:GridView ID="GridView1" CssClass="table" AutoGenerateColumns="False" runat="server" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" ForeColor="Black" PageSize="25" OnDataBound="GridView1_DataBound" OnRowCommand="GridView1_RowCommand">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="ASSEMBLED" HeaderStyle-BackColor="Indigo" HeaderStyle-ForeColor="White">
                                    <ItemTemplate>
