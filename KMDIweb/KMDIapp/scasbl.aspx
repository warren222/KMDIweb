<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KMDIapp/KMDIwebMaster.Master" CodeBehind="scasbl.aspx.cs" Inherits="KMDIweb.KMDIapp.scasbl" %>
<asp:Content runat="server" ID="Content1" ContentPlaceHolderID="head">
    <meta name="viewport" content="width=device-width, initial-scale=1">
      <title>Aluminum Shoot Bolt Lock</title>
</asp:Content>
<asp:Content runat="server" ID="Content2" ContentPlaceHolderID="content">
    ...
    <div class=" jumbotron">
        <div class="row">
            <div class="col-sm-6">
                <h1><strong>Aluminum Shoot Bolt Lock<br />
            ...
            <div class="col-sm-6">
                ...
                <table class="table">
                    <tr>
                        <td style="background-color: indigo; color: white">Aluminum Shoot Bolt Lock</td>
                ...
                <div class="panel-body">
                    <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto">
                           <h3 class="text-center text-success"><span><strong>
                            <asp:Label ID="LBLschedule" runat="server" CssClass="forfont" Text="Aluminum Shoot Bolt Lock Checklist Table"></asp:Label></strong> </span></h3>
                       <asp:GridView ID="GridView1" CssClass="table" AutoGenerateColumns="False" runat="server" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" PageSize="25" OnDataBound="GridView1_DataBound" OnRowCommand="GridView1_RowCommand" GridLines="Vertical">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="ASBL" HeaderStyle-BackColor="Indigo" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:Label ID="LBLasbl" Font-Size="Small" runat="server" Font-Bold="true" Text='<%# Bind("ASBL") %>'></asp:Label>
                                    </ItemTemplate>
                      ...
                      <asp:Panel ID="Panel2" runat="server" ScrollBars="Auto" Visible="false">
                        ...
                        <asp:GridView ID="GridView2" CssClass="table" runat="server" CellPadding="4" ForeColor="#333333" AllowPaging="True" AutoGenerateColumns="False" OnDataBound="GridView2_DataBound" OnPageIndexChanging="GridView2_PageIndexChanging" OnRowCommand="GridView2_RowCommand" PageSize="25" GridLines="None">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="ASBL DATE" HeaderStyle-BackColor="Indigo" HeaderStyle-ForeColor="White">
                                    <ItemTemplate>
                                          <asp:Label ID="g2LBLasbl" Font-Size="Small" runat="server" Font-Bold="true" Text='<%# Bind("ASBL") %>'></asp:Label>
                                    </ItemTemplate>                           
                                    <HeaderStyle BackColor="Indigo" ForeColor="White" />
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:LinkButton ID="BTNcheck" CommandName="check" Visible='<%# Eval("ASBL").ToString() == "" ? true : false %>' runat="server" CssClass="btn btn-success"><span class="glyphicon glyphicon-ok"></span>&nbsp; Check</asp:LinkButton>
