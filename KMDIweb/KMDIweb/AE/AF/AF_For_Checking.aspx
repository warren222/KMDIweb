                                        ...
                                        <ItemTemplate>
                                            <div style="min-width: 370px; white-space: nowrap; margin-bottom: 20px;">
                                                ...
                                                <div style="background-color: cornsilk">
                                                    ...
                                                    <div style="border-left: solid 5px orange; min-height: 35px; border-top: 0.5px solid #bab9b9; padding: 10px">
                                                        <asp:Panel runat="server" Visible='<%# Eval("Req_Status").ToString() == "For Checking" ? true : false %>' ID="pnlCommentEdit">
                                                            ...
                                                            <asp:LinkButton runat="server" ID="btnSave" CommandName="myCheck" CssClass="btn btn-success">s u b m i t</asp:LinkButton>
                                                        </asp:Panel>
                                                        <asp:Panel runat="server" Visible='<%# Eval("Req_Status").ToString() == "For Checking" ? false : true %>' ID="pnlComment">
                                                            <span style="font-size: small"><%# Eval("Checked_Remarks") %><br />
