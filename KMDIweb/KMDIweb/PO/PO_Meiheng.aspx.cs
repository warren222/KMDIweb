...
{
    public partial class PO_Meiheng : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("~/KMDIweb/PO/PO_Sign.aspx" + AddQuerystring + "&PO_Sender=PO_Meiheng&PO_Sign_Field=Web_Prepared_By");
        }
        protected void btnNotedby_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/KMDIweb/PO/PO_Sign.aspx" + AddQuerystring + "&PO_Sender=PO_Meiheng&PO_Sign_Field=Web_Noted_By");
        }
        protected void btnApprovedby_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/KMDIweb/PO/PO_Sign.aspx" + AddQuerystring + "&PO_Sender=PO_Meiheng&PO_Sign_Field=Web_Approved_By");
        }
