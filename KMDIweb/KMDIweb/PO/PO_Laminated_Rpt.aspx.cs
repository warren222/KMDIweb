...
namespace KMDIweb.KMDIweb.PO
{
    public partial class PO_Laminated_Rpt : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("~/KMDIweb/PO/PO_Sign.aspx" + AddQuerystring + "&PO_Sender=PO_Laminated_Rpt&PO_Sign_Field=Web_Prepared_By");
        }
        protected void btnRequestedby_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/KMDIweb/PO/PO_Sign.aspx" + AddQuerystring + "&PO_Sender=PO_Laminated_Rpt&PO_Sign_Field=Web_Requested_By");
        }
        protected void btnNotedby_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/KMDIweb/PO/PO_Sign.aspx" + AddQuerystring + "&PO_Sender=PO_Laminated_Rpt&PO_Sign_Field=Web_Noted_By");
        }
        protected void btnApprovedby_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/KMDIweb/PO/PO_Sign.aspx" + AddQuerystring + "&PO_Sender=PO_Laminated_Rpt&PO_Sign_Field=Web_Approved_By");
        }
