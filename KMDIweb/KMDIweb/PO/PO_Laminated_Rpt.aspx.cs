...
{
    public partial class PO_Laminated_Rpt : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("~/KMDIweb/PO/PO_Sign.aspx?PO_Sender=PO_Laminated_Rpt&PO_Sign_Field=Web_Prepared_By&PO_Search=" + Request.QueryString["PO_Search"].ToString() + "&PO_PageIndex=" + Request.QueryString["PO_PageIndex"].ToString());
        }
        protected void btnRequestedby_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/KMDIweb/PO/PO_Sign.aspx?PO_Sender=PO_Laminated_Rpt&PO_Sign_Field=Web_Requested_By&PO_Search=" + Request.QueryString["PO_Search"].ToString() + "&PO_PageIndex=" + Request.QueryString["PO_PageIndex"].ToString());
        }
        protected void btnNotedby_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/KMDIweb/PO/PO_Sign.aspx?PO_Sender=PO_Laminated_Rpt&PO_Sign_Field=Web_Noted_By&PO_Search=" + Request.QueryString["PO_Search"].ToString() + "&PO_PageIndex=" + Request.QueryString["PO_PageIndex"].ToString());
        }
        protected void btnApprovedby_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/KMDIweb/PO/PO_Sign.aspx?PO_Sender=PO_Laminated_Rpt&PO_Sign_Field=Web_Approved_By&PO_Search=" + Request.QueryString["PO_Search"].ToString() + "&PO_PageIndex=" + Request.QueryString["PO_PageIndex"].ToString());
        }
