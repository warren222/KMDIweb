            ...
            <div class="container">
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        ...
                        <div style="background-color: whitesmoke; padding: 5px; color: black; border: 1px #7b7b7b solid; border-bottom: 0px;">
                            <span>PO Table</span>
                        </div>
                        <asp:GridView runat="server" ID="gvFind" Width="100%" AutoGenerateColumns="False" AllowPaging="True"
                            Style="font-family: Calibri; white-space: nowrap;" OnPageIndexChanging="gvFind_PageIndexChanging" PageSize="5" OnRowCommand="gvFind_RowCommand" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                    ...
                    <ContentTemplate>
                        <asp:Panel ID="pnl" Visible="false" runat="server">
                            ...
                            <div style="background-color: #ff006e; color: white; padding: 5px;">
                                <span>PO Items - select items for notifcation</span>
                            </div>
                            <asp:GridView ID="gvPO_Items" runat="server" Width="100%" AutoGenerateColumns="False"
                                Style="font-family: Calibri; white-space: nowrap;">
                                <Columns>
                                    <asp:TemplateField>
                                        <ItemTemplate>
