<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KMDIweb/Production/ScreenSchedule/ScreenScheduleMaster.Master" CodeBehind="scasbl.aspx.cs" Inherits="KMDIweb.KMDIapp.scasbl" %>
    ...
    <div class=" jumbotron">
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <table class="table">
                    <tr>
                        <td style="background-color: CornflowerBlue; color: white">Aluminum Shoot Bolt Lock</td>
                ...
                <div class="panel-body">
                    <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto">
                        <h1 class="text-center text-success"><span>
                            <asp:Label ID="LBLschedule" runat="server" CssClass="forfont" Text="Aluminum Shoot Bolt Lock Checklist Table"></asp:Label> </span></h1>
                        <small>
                            <asp:GridView ID="GridView1" CssClass="table tbl" AutoGenerateColumns="False" runat="server" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging" CellPadding="4" ForeColor="Black" PageSize="25" OnDataBound="GridView1_DataBound" OnRowCommand="GridView1_RowCommand" GridLines="Vertical" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="ASBL DATE" HeaderStyle-BackColor="CornflowerBlue" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
