<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KMDIweb/Production/FrameSchedule/FrameScheduleMaster.Master" CodeBehind="fhandle.aspx.cs" Inherits="KMDIweb.KMDIweb.Production.FrameSchedule.fhandle" %>


<asp:Content ID="content1" runat="server" ContentPlaceHolderID="head">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>For Handle</title>
    ...
    <div class=" jumbotron">
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <table class="table">
                    <tr>
                        <td style="background-color: CornflowerBlue; color: white">Handle</td>
                ...
                <div class="panel-body">
                    <asp:Panel ID="Panel2" runat="server" ScrollBars="Auto">
                        <h1 class="text-center text-success"><span>
                            <asp:Label ID="LBLschedule" runat="server" CssClass="forfont" Text="Handle Checklist Table"></asp:Label>
                        </span></h1>
                        <small>
                            <asp:GridView ID="GridView1" CssClass="table" AutoGenerateColumns="False" runat="server" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging" CellPadding="4" ForeColor="Black" PageSize="25" OnDataBound="GridView1_DataBound" OnRowCommand="GridView1_RowCommand" GridLines="Vertical" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="HANDEL DATE" HeaderStyle-BackColor="CornflowerBlue" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:Label ID="LBLhandle" Font-Size="Small" runat="server" Font-Bold="true" Text='<%# Bind("handle") %>'></asp:Label>
                                        </ItemTemplate>
                        ...
                        <small>
                            <asp:GridView ID="GridView2" CssClass="table" runat="server" CellPadding="4" ForeColor="Black" AllowPaging="True" AutoGenerateColumns="False" OnDataBound="GridView2_DataBound" OnPageIndexChanging="GridView2_PageIndexChanging" OnRowCommand="GridView2_RowCommand" PageSize="25" GridLines="Horizontal" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="HANDLE DATE" HeaderStyle-BackColor="CornflowerBlue" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:Label ID="g2LBLhandle" Font-Size="Small" runat="server" Font-Bold="true" Text='<%# Bind("handle") %>'></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle BackColor="CornflowerBlue" ForeColor="White" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:LinkButton ID="BTNcheck" CommandName="check" Visible='<%# Eval("handle").ToString() == "" ? true : false %>' runat="server" CssClass="btn btn-success"><span class="glyphicon glyphicon-ok"></span>&nbsp; Check</asp:LinkButton>
