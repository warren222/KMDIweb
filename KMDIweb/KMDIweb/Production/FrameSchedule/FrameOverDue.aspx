...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="content">
    ...
    <div class="container">
        ...
        <asp:Panel runat="server" ID="Panel1" ScrollBars="Auto">
            ...
            <asp:GridView ID="GridView1" CssClass="table tbl" AllowPaging="True" AutoGenerateColumns="False" runat="server" OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="100" CellPadding="3" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CellSpacing="1">
                <Columns>
