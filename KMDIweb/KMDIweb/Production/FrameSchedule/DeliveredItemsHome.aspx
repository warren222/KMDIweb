                    ...
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                ...
                                <asp:LinkButton ID="LinkButton2" CommandName="viewdel" CssClass="btn btn-primary" runat="server">delivered frames</asp:LinkButton>
                                <asp:LinkButton ID="LinkButton3" CommandName="viewdelscreen" CssClass="btn btn-primary" runat="server">delivered screens</asp:LinkButton>
                                <asp:LinkButton ID="LinkButton4" CommandName="viewdelglass" CssClass="btn btn-primary" runat="server">delivered glasses</asp:LinkButton>
                                <hr />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
