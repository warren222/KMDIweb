<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/KMDIweb/Production/FrameSchedule/FrameScheduleMaster.Master" CodeBehind="ffinishing.aspx.cs" Inherits="KMDIweb.KMDIweb.Production.FrameSchedule.ffinishing" %>
    ...
    <div class=" jumbotron">
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <table class="table">
                    <tr>
                        <td style="background-color: CornflowerBlue; color: white">Finishing</td>
                ...
                <div class="panel-body">
                    <asp:Panel ID="Panel2" runat="server" ScrollBars="Auto">
                        <h1 class="text-center text-success"><span>
                            <asp:Label ID="LBLschedule" runat="server" CssClass="forfont" Text="Finishing Checklist Table"></asp:Label>
                        </span></h1>
                        <small>
                            <asp:GridView ID="GridView1" CssClass="table tbl" AutoGenerateColumns="False" runat="server" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging" CellPadding="4" ForeColor="Black" PageSize="25" OnDataBound="GridView1_DataBound" OnRowCommand="GridView1_RowCommand" GridLines="Vertical" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="FINISHING DATE" HeaderStyle-BackColor="CornflowerBlue" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:Label ID="LBLfinishing" Font-Size="Small" runat="server" Font-Bold="true" Text='<%# Bind("finishing") %>'></asp:Label>
                                        </ItemTemplate>
                        ...
                        <small>
                            <asp:GridView ID="GridView2" CssClass="table tbl" runat="server" CellPadding="4" ForeColor="Black" AllowPaging="True" AutoGenerateColumns="False" OnDataBound="GridView2_DataBound" OnPageIndexChanging="GridView2_PageIndexChanging" OnRowCommand="GridView2_RowCommand" PageSize="25" GridLines="Horizontal" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="FINISHING DATE" HeaderStyle-BackColor="CornflowerBlue" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:Label ID="g2LBLfinishing" Font-Size="Small" runat="server" Font-Bold="true" Text='<%# Bind("finishing") %>'></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle BackColor="CornflowerBlue" ForeColor="White" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:LinkButton ID="BTNcheck" CommandName="check" Visible='<%# Eval("finishing").ToString() == "" ? true : false %>' runat="server" CssClass="btn btn-success"><span class="glyphicon glyphicon-ok"></span>&nbsp; Check</asp:LinkButton>
