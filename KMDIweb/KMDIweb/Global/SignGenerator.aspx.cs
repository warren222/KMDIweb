...
{
    public partial class SignGenerator : System.Web.UI.Page
    {
        ...
        private void senderbutton()
        {
            if (IsValid)
            {
                ...
                UploadImage(Request.Form["myurl"].ToString().Replace("data:image/png;base64,", ""), Server.MapPath(filepath + tboxName.Text + ".jpg"));
            }
        }
    }
}